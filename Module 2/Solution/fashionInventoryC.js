...
function renderFilteredGoodsStringForDesigner(designerObject) {
  return renderBlackShoesForDesigner(
    designerObject.name,
...
assertObjectsEqual(
  actualShoeObject,
  expectedShoeObject,
  'should return black shoe object'
);

assertEqual(
  blackShoesForDesigner.length,
  1,
  'should return an array with only one object'
);

var blackShoesStringForDesigner = renderFilteredGoodsStringForDesigner(
  designerObject
);
var expectedBlackShoesString =
  'Brunello Cucinelli, tasselled black low-top lace-up, 1000';

assertEqual(
  blackShoesStringForDesigner,
  expectedBlackShoesString,
  'should return properly formatted string'
);
...
assertEqual(
  ...
  'should return expected lines of output'
);
