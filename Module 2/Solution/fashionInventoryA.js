...
var shoesForDesigner = renderShoesForDesigner(
  designerObject.name,
  designerObject.shoes
);
var actualShoeString = shoesForDesigner[0];
var expectedShoeString =
  'Brunello Cucinelli, tasselled black low-top lace-up, 1000';

assertEqual(
  actualShoeString,
  expectedShoeString,
  'should return shoe string in proper format'
);

var actualGoodsStringForDesigner = renderGoodsStringForDesigner(designerObject);
var expectedGoodsStringForDesigner =
  'Brunello Cucinelli, tasselled black low-top lace-up, 1000\nBrunello Cucinelli, tasselled green low-top lace-up, 1100\nBrunello Cucinelli, plain beige suede moccasin, 950\nBrunello Cucinelli, plain olive suede moccasin, 1050';

assertEqual(
  actualGoodsStringForDesigner,
  expectedGoodsStringForDesigner,
  'should return goods for designer in proper format'
);
