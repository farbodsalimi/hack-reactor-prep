...
assertEqual(
  sum([1, 2, 3]),
  6,
  'should return the sum of the integers in the given array'
);
assertEqual(
  average([4, 5, 6]),
  5,
  'should return the average of the integers in the given array'
);
assertObjectsEqual(
  getShoePrices(inventory[0]),
  [1000, 1100, 950, 1050],
  'should filter to shoe prices'
);
...
assertObjectsEqual(
  actualOutput,
  expectedOutput,
  'should return the expected output object'
);
